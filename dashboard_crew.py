...
import argparse # We need this for the __main__ block
...
# --- 2. DEFINE THE SPECIALIST AGENTS (Loading from .env) ---
...
# --- 3. DEFINE THE DILIGENCE TASKS ---

def create_diligence_tasks(business_idea):
...
# --- 4. CREATE THE CALLABLE FUNCTION FOR THE APP ---
def run_kairos_crew(topic: str) -> str:
    ...
    diligence_tasks = create_diligence_tasks(topic)
